    ...
    <div
        ...
        <div style="max-width: 600px; margin: 0 auto;">
            <div style="text-align: center; padding-bottom: 20px; padding-top: 30px;">
                <span style="font-weight: 700; font-size: 32px; color: #000;">Reset mật khẩu</span>
            </div>
            <div style="border-top: 3px solid #B1E0E6; color: #525c65; padding: 10px; background: #fff;">

                <p style="margin: 5px 0;color: #000; font-weight:600">Xin chào {{$data['email']}},</p>
                <p style="margin: 5px 0;color: #525c65"> Mật khẩu mới của bạn là {{ $data['new_pass']}}</p>
            </div>  
