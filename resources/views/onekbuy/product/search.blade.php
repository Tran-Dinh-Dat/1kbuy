                ...
                <div class="row row-shop">
                    <div class="col-12 col-lg-8 col-xl-9 shop-left ">
                        <div class="row">
                            ...
                            @else 
                            <p class="custom-notfound">Không tìm thấy sản phẩm nào</p>
                            @endif
...
@section('header')
    ...
    <link rel="canonical" href="{{ route('onekbuy.product.search') }}" />
    <!-- Meta for Google -->
    <meta property="og:title" itemprop="name" content="Tin tức về 1kbuy.vn. Hệ thống mua hàng chỉ với 1.000 đồng" />    
    <meta property="og:url" itemprop="url" content="{{ route('onekbuy.product.search') }}" />
