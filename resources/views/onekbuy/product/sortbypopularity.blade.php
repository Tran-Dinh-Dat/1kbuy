                    ...
                    <div class="col-12 col-lg-8 col-xl-9 shop-left ">
                        <div class="row">
                            <div class="col-6 col-md-9 custom-filter">
                                    <p>Showing 1-18 of {{$countsort->count()}} results</p>
                            </div>
                            <div class="col-6 col-md-3 custom-filter">                             
                                <form class="form-inline">
                                    <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" onchange="location = this.value">
                                        <option {{$sort=='default'?'selected':''}} value="{{route('onekbuy.product.sort' , 'default')}}">Default Sorting...</option>
                                        <option {{$sort=='popularity'?'selected':''}} value="{{route('onekbuy.product.sort','popularity')}}">Sort by popularity</option>
                                        <option {{$sort=='lastest'?'selected':''}} value="{{route('onekbuy.product.sort','lastest')}}">Sort by latest</option>
                                        <option {{$sort=='low-to-high'?'selected':''}} value="{{route('onekbuy.product.sort','low-to-high')}}">Sort by price: low to high</option>
                                        <option {{$sort=='high-to-low'?'selected':''}} value="{{route('onekbuy.product.sort','high-to-low')}}">Sort by price: high to low</option>
                                    </select>
                                </form>
                            </div>
