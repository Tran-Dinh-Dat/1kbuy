...
@section('header')
    ...
    <link rel="canonical" href="{{ route('onekbuy.product.mostchosen') }}" />
    <!-- Meta for Google -->
    <meta property="og:title" itemprop="name" content="Tin tức về 1kbuy.vn. Hệ thống mua hàng chỉ với 1.000 đồng" />    
    <meta property="og:url" itemprop="url" content="{{ route('onekbuy.product.mostchosen') }}" />
