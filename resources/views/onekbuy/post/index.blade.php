                        ...
                        @foreach ($post as $item)
                            <div class="row row-blog-item">
                                ...
                                <div class="col-12 col-md-6 col-lg-8">
                                    <div class="blog-text">
                                    <h4><a href={{route('onekbuy.post.detail',['id' => $item->id,'slug' => $item->slug]) }}>{{$item->title}}</a></h4>
...
@section('header')
    ...
    <link rel="canonical" href="{{ route('onekbuy.post.index') }}" />
    <!-- Meta for Google -->
    <meta property="og:title" itemprop="name" content="Tin tức về 1kbuy.vn. Hệ thống mua hàng chỉ với 1.000 đồng" />    
    <meta property="og:url" itemprop="url" content="{{ route('onekbuy.post.index') }}" />
