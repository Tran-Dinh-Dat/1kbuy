                            ...
                            <div class="row row-blog-item">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="blog-image">
                                        <a href={{route('onekbuy.notification.show',['id' => $item->id,'slug' => $item->slug]) }}>
                                ...
                                <div class="col-12 col-md-6 col-lg-8">
                                    <div class="blog-text">
                                    <h4><a href={{route('onekbuy.notification.show',['id' => $item->id,'slug' => $item->slug]) }}>{{$item->title}}</a></h4>
...
@section('header')
    ...
    <link rel="canonical" href="https://1kbuy.vn/notification" />
    <!-- Meta for Google -->
    <meta property="og:title" itemprop="name" content="Hệ thống mua hàng chỉ với 1.000 đồng. 1kbuy.vn" />    
    <meta property="og:url" itemprop="url" content="https://1kbuy.vn/notification" />
