            ...
            <div class="container container-shop">
                <div class="row row-shop">
                    <div class="col-12 col-lg-8 col-xl-9 shop-left ">
                            ...
                            @endforeach
                            @else 
                            <p class="custom-notfound">Không tìm thấy thông báo nào</p>
                            @endif
...
@section('header')
    ...
    <link rel="canonical" href="https://1kbuy.vn/search-notification" />
    <!-- Meta for Google -->
    <meta property="og:title" itemprop="name" content="Hệ thống mua hàng chỉ với 1.000 đồng. 1kbuy.vn" />    
    <meta property="og:url" itemprop="url" content="https://1kbuy.vn/search-notification" />
