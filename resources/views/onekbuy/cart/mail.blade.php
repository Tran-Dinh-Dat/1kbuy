    ...
    <div
        ...
        <div style="max-width: 700px; margin: 0 auto;">
            <div style="text-align: center; padding-bottom: 20px; padding-top: 30px;">
                <span style="font-weight: 700; font-size: 32px; color: #000;">Hoàn tất đơn hàng</span>
            </div>
            ...
            <p style="margin: 5px 0;color: #525C65">Xin chào bạn {{ $data['name']}}!</p>
                <p style="margin: 5px 0;color: #525C65">Cảm ơn bạn đã đặt hàng tại 1kbuy.vn. Mã đơn hàng của bạn là 1kbuy{{$data['id']}}. Vui lòng thanh toán theo 1 trong những hình thức sau:</p>
                <p style="margin: 5px 0;color: #525C65">Xem hướng dẫn thanh toán qua tài khoản ngân hàng <a href="https://1kbuy.vn/thong-tin/huong-dan-thanh-toan">tại đây</a></p>
            </div>
            <div >
            </div>
