    ...
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <strong class="card-title">Quản lý xuất dữ liệu đơn hàng 1 năm</strong>
                    </div>
                    <div class="">
                        ...
                        <table class="table ">
                            ...
                            @while ($i != 12)
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.installment.export', ['yesterday' => $yesterday, 'today' => $today]) }}" class="btn btn-info">Export</a></td>
                                </tr>
                            @endwhile
                            </tbody>
                        </table>
