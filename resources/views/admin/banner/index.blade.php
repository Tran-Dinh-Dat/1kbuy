        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <a href="{{ route('admin.banner.create')}}" class="btn btn-success">Thêm</a>
                    </div>
                    <div class="">
                        ...
                        <table class="table ">
                            ...
                            <tbody>
                                @foreach ($banners as $item)
                                    <tr id="tableBannerId{{$item->id}}">
                                        <td>#{{ $item->id }} </td>
                                        <td><img width="100px" src="{{ asset('upload/images/'. $item->image)}}" alt=""></td>
                                        <td><a href="">{{ $item->link}}</a> </td>
                                        <td>
                                            <a href="{{ route('admin.banner.edit', $item->id)}}" class="btn btn-info">Sửa</a>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('admin.banner.destroy', $item->id)}}" class="btn btn-danger deleteBanner" data-id="{{ $item->id }}" data-dismiss="modal">Xóa</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
@endsection
@section('javascript')
    <script src="{{ asset('asset/admin/assets/js/adminJs/banner.js')}}"></script>
@endsection